...
public class DoPauseBlitzRace03 : MonoBehaviour // Monobehaviour is a parent class from which DoPauseBlitzRaceTrack03 derives. In fact, all script classes derive from Monobehaviour.
{
	...
	{
		CheckPointScriptBlitzRace03.noofcheckpoints = 0;
		SceneManager.LoadScene (8); // Load scene with index number 8 which is actually the same scene again.
