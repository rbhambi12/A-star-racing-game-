...
public class BlitzTimerScript : MonoBehaviour 
{
	...
	public static float millisec=999;
	...
	public void Start()
	{
		...
		RemainingTimeSec.GetComponent<Text> ().text = "10";
		RemainingTimeMillisec.GetComponent<Text> ().text = "5";
