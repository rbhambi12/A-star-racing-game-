...
public class DoPauseRaceTrack3 : MonoBehaviour // Monobehaviour is a parent class from which DoPauseRaceTrack3 derives. In fact, all script classes derive from Monobehaviour.
{
	...
	{
		SceneManager.LoadScene (5); // Load scene with index number 5 which is actually the same scene again.
