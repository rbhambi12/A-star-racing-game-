...
public class DoPauseBlitzRace02 : MonoBehaviour // Monobehaviour is a parent class from which DoPauseBlitzRaceTrack02 derives. In fact, all script classes derive from Monobehaviour.
{
	...
	{
		SceneManager.LoadScene (7); // Load scene with index number 7 which is actually the same scene again.
