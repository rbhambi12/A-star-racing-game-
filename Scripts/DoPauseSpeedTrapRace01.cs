...
public class DoPauseSpeedTrapRace01 : MonoBehaviour // Monobehaviour is a parent class from which DoPauseBlitzRaceTrack03 derives. In fact, all script classes derive from Monobehaviour.
{
	...
	public void RaceRestart() // User defined function. This function is NOT called automatically by Unity. It is instead called by a button.
	{
		...
		SceneManager.LoadScene (9); // Load scene with index number 8 which is actually the same scene again.
