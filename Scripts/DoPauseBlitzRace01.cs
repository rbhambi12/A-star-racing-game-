...
public class DoPauseBlitzRace01 : MonoBehaviour // Monobehaviour is a parent class from which DoPauseBlitzRaceTrack01 derives. In fact, all script classes derive from Monobehaviour.
{
	...
	{
		SceneManager.LoadScene (6); // Load scene with index number 6 which is actually the same scene again.
