...
public class ArtificialIntelligenceCar02RaceTrack3 : MonoBehaviour 
{
...
public GameObject Waypoint33;
	...
	public void Update()
	{
		...
		case 23:
			...
			break;
		case 24:
			WaypointTracker.transform.position = Waypoint24.transform.position;
			break;
		case 25:
			WaypointTracker.transform.position = Waypoint25.transform.position;
			break;
		case 26:
			WaypointTracker.transform.position = Waypoint26.transform.position;
			break;
		case 27:
			WaypointTracker.transform.position = Waypoint27.transform.position;
			break;
		case 28:
			WaypointTracker.transform.position = Waypoint28.transform.position;
			break;
		case 29:
			WaypointTracker.transform.position = Waypoint29.transform.position;
			break;
		case 30:
			WaypointTracker.transform.position = Waypoint30.transform.position;
			break;
		case 31:
			WaypointTracker.transform.position = Waypoint31.transform.position;
			break;

		case 32:
			WaypointTracker.transform.position = Waypoint32.transform.position;
			break;
		case 33:
			WaypointTracker.transform.position = Waypoint33.transform.position;
			break;
